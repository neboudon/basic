...
from obstacle_func import send_motor_command, process_step,process_horizontal_obstacle
...
def main():
    ...
    depth_start_x = depth_center_x - (strip_width//2)
    depth_end_x = depth_center_x + (strip_width//2)
